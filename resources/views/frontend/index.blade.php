    ...
    <div class="home-banner-area mb-4 pt-3">
        <div class="container">
            <div class="row gutters-10 position-relative">
                ...
                <div class="col-lg-12 order-3 my-5 deal-today">
                    <div class="rounded shadow-sm">
                        <div class="d-flex flex-wrap mb-3 align-items-baseline justify-content-center mx-3">
                            <h3 class="h5 fw-700 mt-3 mb-0 bg-white heading-text mt-5 text-primary">
                            <span class="pb-2 d-inline-block"> {{ translate('Todays Deal') }}</span>
                            <span class="badge badge-primary badge-inline mx-2">{{ translate('Hot') }}</span>
                            </h3>
                            
                    </div>
                        
                        <div class="c-scrollbar-light overflow-auto p-2 rounded-bottom">
                            <div class="gutters-5 lg-no-gutters row">
                            @foreach ($todays_deal_products as $key => $product)
                                @if ($product != null)
                                <div class="col-lg-3 col-md-6 col-sm-6 col-6 mb-2">
                                    <div class="border m-2 bg-white">
                                        <a href="{{ route('product', $product->slug) }}" class="d-block text-reset bg-white h-100 rounded">
                                       
                                            <div>
                                                <div class="img">
                                                    <img
                                                        class="lazyload img-fit border-bottom"
                                                        src="{{ static_asset('assets/img/placeholder.jpg') }}"
                                            ...
                                            <div class="d-flex justify-content-between p-3 bg-white deal-price">
                                                    ...
                                                    <a href="{{ route('product', $product->slug) }}" class="btn btn-outline-primary">Grab Now</a>
                                            </div>
            ...
            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                ...
                <div class="d-flex flex-wrap mb-3 align-items-baseline border-bottom">
                    <h3 class="h5 fw-700 mb-0">
                        <span class="text-secondary border-bottom border-primary border-width-2 pb-3 d-inline-block">{{ translate('Flash Sale') }}</span>
                    </h3>
                    <div class="aiz-count-down ml-auto ml-lg-3 align-items-center" data-date="{{ date('Y/m/d H:i:s', $flash_deal->end_date) }}"></div>
                    <a href="{{ route('flash-deal-details', $flash_deal->slug) }}" class="ml-auto mr-0 btn btn-outline-success btn-sm shadow-md w-100 w-md-auto">{{ translate('View More') }}</a>
                </div>
                ...
                <div class="container">
                    <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                        <div class="d-flex mb-3 align-items-baseline border-bottom">
                            <h3 class="h5 fw-700 mb-0">
                                <span class="text-secondary border-bottom border-primary border-width-2 pb-3 d-inline-block">
               ...
               <section class="mb-4">
                   <div class="container">
                       <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                            <div class="d-flex mb-3 align-items-baseline border-bottom">
                                <h3 class="h5 fw-700 mb-0">
                                    <span class="text-secondary border-bottom border-primary border-width-2 pb-3 d-inline-block">{{ translate('Classified Ads') }}</span>
                                </h3>
                                <a href="{{ route('customer.products') }}" class="ml-auto mr-0 btn btn-outline-success btn-sm shadow-md">{{ translate('View More') }}</a>
                            </div>
                           <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true'>
            ...
            <div class="row gutters-10">
                @if (get_setting('top10_categories') != null)
                    <div class="{{ $col_section }}">
                        <div class="d-flex mb-3 align-items-baseline border-bottom">
                            <h3 class="h5 fw-700 mb-0">
                                <span class="text-secondary border-bottom border-primary border-width-2 pb-3 d-inline-block">{{ translate('Top 10 Categories') }}</span>
                            </h3>
                            <a href="{{ route('categories.all') }}" class="ml-auto mr-0 btn btn-outline-primary bg-white hov-bg-primary btn-sm shadow-md">{{ translate('View All Categories') }}</a>
                        </div>
                ...
                @if (get_setting('top10_brands') != null)
                    <div class="{{ $col_section }}">
                        <div class="d-flex mb-3 align-items-baseline border-bottom">
                            <h3 class="h5 fw-700 mb-0">
                                <span class="text-secondary border-bottom border-primary border-width-2 pb-3 d-inline-block">{{ translate('Top 10 Brands') }}</span>
                            </h3>
                            <a href="{{ route('brands.all') }}" class="ml-auto mr-0 btn btn-outline-primary bg-white hov-bg-primary btn-sm shadow-md">{{ translate('View All Brands') }}</a>
                        </div>
                        <div class="row gutters-5">
