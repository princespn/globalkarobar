                ...
                <div class="row">
                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="cat-description">
                            <h1>{{ \App\Models\Category::find($category_id)->getTranslation('name') }}</h1>
                            <p>Kathmandu, the capital city of Nepal, is known for its rich cultural heritage, and in recent years, it has also emerged as a fashion hub. The city has seen a surge in the number of fashion shops, offering a range of trendy and fashionable clothing items to its customers. </p>
                            <h2>Ethnic Fusion:</h2>
                            <p> Kathmandu has a diverse population, and this is reflected in the fashion trends. Ethnic fusion wear is becoming increasingly popular, with designers blending traditional Nepalese elements with contemporary styles. This trend is particularly popular among young adults who want to showcase their Nepalese identity while keeping up with the latest fashion trends.</p>
                            <h2>Sustainable Fashion:</h2>
                            <p> There has been a growing awareness about sustainable fashion, and Kathmandu's fashion shops have responded to this trend by offering eco-friendly clothing items. Consumers can now find clothing made from organic cotton, bamboo, and recycled fabrics, among others. Sustainable fashion is not only good for the environment, but it also supports local communities and promotes ethical practices in the fashion industry.</p>
                            <h2>Streetwear:</h2>
                            <p>The streetwear trend has taken over the world, and Kathmandu is no exception. Streetwear-inspired clothing, such as oversized hoodies, graphic t-shirts, and statement sneakers, can be found in many fashion shops in Kathmandu. This trend is popular among young adults who want to make a statement with their clothing choices.</p>
                            <h2>Bold Colors and Prints:</h2>
                            <p>Bold colors and prints are making a comeback in Kathmandu's fashion scene. Vibrant hues such as red, yellow, and green are being paired with bold prints, such as animal prints, florals, and stripes. This trend is perfect for those who want to add a pop of color to their wardrobe.</p>
                            <h2>Minimalism:</h2>
                            <p>While bold colors and prints are popular, the minimalist trend is also making a statement in Kathmandu's fashion scene. Clean lines, simple silhouettes, and neutral colors are being embraced by many fashion shops. This trend is perfect for those who want to keep their wardrobe simple and classic.</p>
                            <p>Overall, the fashion scene in Kathmandu is diverse and exciting, with something for everyone. Whether you're looking for traditional Nepalese clothing or the latest streetwear-inspired trends, you're sure to find it in Kathmandu's fashion shops.</p>
                        </div>
                    </div>
                </div>
            </form>
