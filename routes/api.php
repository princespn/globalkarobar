...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function() {
    ...
    Route::group(['middleware' => ['app_user_unbanned']], function() {
        ...
        Route::get('cart-summary', 'App\Http\Controllers\Api\V2\CartController@summary');
        ...
        Route::delete('/delete/{id}', 'App\Http\Controllers\Api\V2\CartController@removeFromCart')->middleware('auth:sanctum');
